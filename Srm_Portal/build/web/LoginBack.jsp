        ...
        <div style="font-size: 12px;width: 1200px;margin: 0 auto;">
            ...
            <div  class="content" style="width: 1200px;padding: 0px;">
                <div class="left" style="float: left;">
                    ...
                    <!--</div>-->
                    <div class="purannounce"  style="width: 798px;height: 620px;overflow: hidden;border: 1px solid;">
                ...
                <div class="right" style="float: right;">
                    ...
                    <div class="connection" style="width: 385px;height: 200px;border: 1px solid;margin-top: 8px;">
                        <div class="area" style="background-color: #DFEAFC;width: 385px; height: 50px;text-align:center;border-bottom: 1px solid;">
                            <span class="title" style="font-weight:700;font-size:28px;line-height: 50px;"><fmt:message key="srm000014" bundle="${messages}"/></span>
                        </div>
                        <div class="connect" style="margin: 25px 20px auto;font-size: 16px;height: 18px;font-weight: 700;"><fmt:message key="srm000015" bundle="${messages}"/></div>
                        <div class="connect" style="margin: 25px 20px auto;font-size: 16px;height: 18px;font-weight: 700;"><fmt:message key="srm000016" bundle="${messages}"/></div>
                        <div class="connect" style="margin: 25px 20px auto;font-size: 16px;height: 18px;font-weight: 700;"><fmt:message key="srm000017" bundle="${messages}"/></div>
                    </div>
